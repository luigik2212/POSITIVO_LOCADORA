...
<tr>
  ...
  <td>
    ...
    <form method="POST" action="<?= url('/vehicles/inactivate') ?>" class="d-inline" onsubmit="return confirm('Inativar veículo?')"><input type="hidden" name="_token" value="<?= csrfToken() ?>"><input type="hidden" name="id" value="<?= $v['id'] ?>"><button class="btn btn-sm btn-danger">Inativar</button></form>
  </td>
</tr>

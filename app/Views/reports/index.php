...
<div class="d-flex justify-content-between align-items-center mb-3">
  ...
  <a class="btn btn-outline-primary" href="<?= url('/reports/pdf?' . http_build_query($_GET)) ?>" target="_blank">Baixar PDF</a>
</div>
    ...
    <form method="GET" class="row g-2 justify-content-center align-items-end">
      <div class="col-md-4">
        ...
        <select name="report_type" class="form-select">
          <option value="vehicle" <?= $reportType === 'vehicle' ? 'selected' : '' ?>>Relatório de carro</option>
          <option value="financial" <?= $reportType === 'financial' ? 'selected' : '' ?>>Relatório financeiro</option>
        </select>
      </div>
      <div class="col-md-3">
  ...
  <div class="card mb-4">
    ...
    <div class="card-body">
      <form method="GET" class="row g-2 align-items-end mb-3">
        <input type="hidden" name="report_type" value="vehicle">
        ...
        <div class="col-md-4">
          ...
          <input type="text" name="vehicle_search" class="form-control" value="<?= esc($vehicleSearch) ?>">
        </div>
        <div class="col-md-5">
      ...
      <?php if (!$selectedVehicle): ?>
        <div class="alert alert-info mb-0">Selecione um veículo para visualizar os dados.</div>
      <?php else: ?>
        <div class="mb-3">
        ...
        <table class="table table-striped align-middle mb-0">
          ...
          <tbody>
            <?php if (!$financialEvolution): ?>
              <tr><td colspan="4" class="text-center text-muted">Nenhuma movimentação financeira encontrada.</td></tr>
